...
public class Edge<T> {
	...
	/**
	 * This method checks if the inputed node is in the edge. returns true if the
	 * given node is type of the edge
	 * 
	 * @param node
	 * @return boolean
	 */
	...
	/**
	 * This method returns the second node
	 * 
	 * @return node<T>
	 */
	...
	/**
	 * this method returns the other node from an edge from the inputed node if the
	 * node does not have an edge: return null
	 * 
	 * @param source
	 * @return Node<T>
	 */
