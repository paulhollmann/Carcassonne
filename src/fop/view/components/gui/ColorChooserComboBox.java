...
/**
 * 
 * this class creates am JComboBox with the available MeepleColors. The
 * background colors are set via the JComboBoxRenderer class
 */
...
class JComboBoxRenderer<String> extends JPanel implements ListCellRenderer<String> {
	...
	/**
	 * creates a panel and a text inside and the text will set the background color
	 * via the getListCellRendererComponent method
	 * 
	 * @param combo
	 * @param color
	 */
